...
async function response(){
  if(count===1)await commit({schema_version:'1.0',turn_id:'handoff_demo',stage:'experience',segments:[segment('jobs_a','jobs','好，先把最重要的那件事做好。那些听起来很诱人的功能，你也舍得先放下。这件事聊清楚了。','click','approval'),segment('jobs_b','jobs','接下来请我们的用户代表：小黑和你聊一聊。','click'),segment('black_a','xiaohei','你们刚才聊的我看到了。听起来挺顺，可我不会捧着说明书用啊。','click','skeptical'),segment('black_b','xiaohei','我写了一大段，手滑关了窗口。再打开，文字还在吗？别让我白打。','reply','angry')]});

...
async function response(){
  if(themePreview&&count===1)await commit({schema_version:'1.0',turn_id:'jobs_theme_demo',stage:'design',segments:[segment('jobs_question','jobs','先别急着加功能。这个东西，你最想让人用完之后记住什么？只留下一件事。','reply','thinking')]});
